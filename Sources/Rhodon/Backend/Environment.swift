 ...
 */
public struct RhodonEnvironment: @unchecked Sendable {
...
private final class CurrentEnvironmentStorage: @unchecked Sendable {
    ...
    private var environment = RhodonEnvironment()

    var value: RhodonEnvironment {
        get {
...
public var current: RhodonEnvironment {
    get {
...
public struct Keychain: @unchecked Sendable {
    private static let service = "eu.mpwg.rhodon"
