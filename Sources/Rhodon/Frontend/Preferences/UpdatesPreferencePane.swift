...
struct UpdatesPreferencePane: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            GroupBox(label: Text("Rhodon Updates")) {
                VStack(alignment: .leading) {
                    Toggle(
                    ...
                    .disabled(updater.disableAutoUpdateRhodon)
...
class ObservableUpdater {
    ...
    var disableAutoUpdateRhodon: Bool {
...
extension String {
    static let appcast = "https://www.rhodon.app/appcast.xml"
    static let prereleaseAppcast = "https://www.rhodon.app/appcast_pre.xml"
}
