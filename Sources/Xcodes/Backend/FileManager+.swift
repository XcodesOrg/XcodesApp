...
extension FileManager {
    /**
     ...
     This implementation exists only to make the existing method more idiomatic by returning the resulting URL instead
     of setting the value on an inout argument.
